...
echo "  pip install git+https://github.com/PaulHax/align-data.git"
echo ""
echo "To use with align-system manually, run:"
echo "  export ICL_DATA_PATH=$EXTRACTED_DIR/align_data/data"